              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    _SpotsLeftBadge(spots: venue.availableSpots, status: venue.status),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.roofing, color: Colors.grey, size: 20),
                        SizedBox(width: 8),
                    ...
                    ElevatedButton(
                      ...
                      child: Text(venue.status == VenueStatus.full ? 'Notify Me' : 'Book Now'),
                    ),
                  ],
                ),
              ],
